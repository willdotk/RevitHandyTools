...
namespace RevitHandyTools.SharedParameters
{
    class SharedParametersMain
    {
        public SharedParametersMain(UIControlledApplication uIControlledApplication)
        {
            ...
            RibbonPanel sharedParametersPanel = RHTRibbonPanelSetting.ribbonPanel(uIControlledApplication, "Shared Parameters");
            ...
            loadOptionButton.LargeImage = RHTRibbonPanelSetting.GetEmbeddedImage("RevitHandyTools.Resources.add_img_32x32.png");
