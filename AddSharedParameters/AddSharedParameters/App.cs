...
namespace AddSharedParameters
{
    class App : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication a)
        {
            ...
            PushButton pushbutton = panel.AddItem(new PushButtonData("AddSharedParameterBtnData", "Add to project", thisAssemblyPath, "AddSharedParameters.Command")) as PushButton;
